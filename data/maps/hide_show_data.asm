...
Route2HS:
	...
	db ROUTE_2, ROUTE2_VIRIZION,   SHOW
Route4HS:
	db ROUTE_4, ROUTE4_TM_WHIRLWIND, SHOW
Route9HS:
	db ROUTE_9, ROUTE9_TM_PSYWAVE, SHOW
Route12HS:
	db ROUTE_12, ROUTE12_SNORLAX,        SHOW
	db ROUTE_12, ROUTE12_KELDEO,         SHOW
	db ROUTE_12, ROUTE12_TM_SHADOW_BALL, SHOW
...
Route25HS:
	...
	db ROUTE_25, ROUTE25_COBALION,        SHOW
BluesHouseHS:
...
OaksLabHS:
	...
	db OAKS_LAB, OAKSLAB_TEPIG_POKE_BALL,      SHOW
	db OAKS_LAB, OAKSLAB_OSHAWOTT_POKE_BALL,   SHOW
	db OAKS_LAB, OAKSLAB_SNIVY_POKE_BALL,      SHOW
...
CeladonMansionRoofHouseHS:
	db CELADON_MANSION_ROOF_HOUSE, CELADONMANSION_ROOF_HOUSE_MELOETTA, SHOW
GameCornerHS:
...
RockTunnel1FHS:
	db ROCK_TUNNEL_1F, ROCKTUNNEL1F_TERRAKION, SHOW
PowerPlantHS:
...
VictoryRoad2FHS:
	db VICTORY_ROAD_2F, VICTORYROAD2F_FOSSIL,         SHOW
	db VICTORY_ROAD_2F, VICTORYROAD2F_TM_BRICK_BREAK, SHOW
...
PokemonMansion2FHS:
	...
	db POKEMON_MANSION_2F, POKEMONMANSION2F_LANDORUS, SHOW
PokemonMansion3FHS:
...
SafariZoneEastHS:
	...
	db SAFARI_ZONE_EAST, SAFARIZONEEAST_TM_SLUDGE_BOMB, SHOW
SafariZoneNorthHS:
