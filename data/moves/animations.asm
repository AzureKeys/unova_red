...
BrickBreakAnim:
	...
	battle_anim MEGA_PUNCH, SUBANIM_0_STAR_DESCENDING, 0, 8
	db -1 ; end
...
HurricaneAnim:
	battle_anim PETAL_DANCE, SE_DARK_SCREEN_PALETTE
...
NightDazeAnim:
	...
	battle_anim NO_MOVE, SUBANIM_0_STAR_TWICE, 0, 5
	battle_anim NO_MOVE, SE_RESET_SCREEN_PALETTE
	db -1 ; end
...
StormThrowAnim:
	...
	battle_anim SHADOW_BALL, SUBANIM_1_SPHERE_BIG, 1, 1
...
DoubleTeamAnim:
	...
	battle_anim NO_MOVE, SE_SHOW_MON_PIC
	battle_anim IRON_DEFENSE, SUBANIM_1_BARRIER, 1, 6
	db -1 ; end
...
ShadowBallAnim:
	...
	battle_anim SHADOW_BALL, SUBANIM_1_CIRCLE_BLACK_TOSS, 1, 3
...
ThrowRockAnim:
	battle_anim SHADOW_BALL, SUBANIM_0_SAFARI_ROCK, 0, 3
	db -1 ; end

ThrowBaitAnim:
	battle_anim SHADOW_BALL, SUBANIM_0_SAFARI_BAIT, 0, 3
	db -1 ; end
