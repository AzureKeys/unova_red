...
; Route 8
	...
	db 19, PIDGEY, RATTATA, NIDORAN_F, MEOWTH, NIDORAN_F, 0
	db 22, CLEFAIRY, CLEFAIRY, 0
; Celadon Gym
	db 23, BELLSPROUT, WEEPINBELL, 0
	db 23, ODDISH, GLOOM, 0
; Viridian Forest
	db 6, NIDORAN_F, NIDORAN_F, 0
...
; Viridian Gym
	db $FF, 50, DUGTRIO, 53, PERSIAN, 53, NIDOQUEEN, 55, NIDOKING, 0
