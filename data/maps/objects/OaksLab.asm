	...
	const_export OAKSLAB_TEPIG_POKE_BALL
	const_export OAKSLAB_OSHAWOTT_POKE_BALL
	const_export OAKSLAB_SNIVY_POKE_BALL
...
OaksLab_Object:
	...
	object_event  6,  3, SPRITE_POKE_BALL, STAY, NONE, TEXT_OAKSLAB_TEPIG_POKE_BALL
	object_event  7,  3, SPRITE_POKE_BALL, STAY, NONE, TEXT_OAKSLAB_OSHAWOTT_POKE_BALL
	object_event  8,  3, SPRITE_POKE_BALL, STAY, NONE, TEXT_OAKSLAB_SNIVY_POKE_BALL
