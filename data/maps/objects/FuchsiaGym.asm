...
FuchsiaGym_Object:
	...
	def_object_events
	object_event  4, 10, SPRITE_SILPH_WORKER_M, STAY, DOWN, TEXT_FUCHSIAGYM_KOGA, OPP_KOGA, 1
	object_event  8, 13, SPRITE_ROCKER, STAY, DOWN, TEXT_FUCHSIAGYM_ROCKER1, OPP_JUGGLER, 3
	object_event  7,  8, SPRITE_ROCKER, STAY, RIGHT, TEXT_FUCHSIAGYM_ROCKER2, OPP_JUGGLER, 1
	object_event  1, 12, SPRITE_ROCKER, STAY, DOWN, TEXT_FUCHSIAGYM_ROCKER3, OPP_JUGGLER, 4
	...
	object_event  2,  7, SPRITE_ROCKER, STAY, LEFT, TEXT_FUCHSIAGYM_ROCKER6, OPP_JUGGLER, 2
