	...
	const_export ROUTE12_TM_SHADOW_BALL
...
Route12_Object:
	...
	object_event  5, 87, SPRITE_MONSTER, STAY, DOWN, TEXT_ROUTE12_KELDEO, KELDEO, 25
	...
	object_event 11, 92, SPRITE_COOLTRAINER_M, STAY, LEFT, TEXT_ROUTE12_COOLTRAINER_M, OPP_JR_TRAINER_M, 8
	...
	object_event  5, 91, SPRITE_FISHER, STAY, DOWN, TEXT_ROUTE12_FISHER5, OPP_FISHER, 7
	object_event 14, 35, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE12_TM_SHADOW_BALL, TM_SHADOW_BALL
