...
Route25_Object:
	...
	def_object_events
	object_event 49,  2, SPRITE_MONSTER, STAY, DOWN, TEXT_ROUTE25_COBALION, COBALION, 20
	...
	object_event 24,  4, SPRITE_COOLTRAINER_M, STAY, DOWN, TEXT_ROUTE25_COOLTRAINER_M, OPP_JR_TRAINER_M, 4
