	object_const_def
	const_export POKEMONMANSION2F_LANDORUS
...
PokemonMansion2F_Object:
	...
	def_object_events
	object_event 24, 10, SPRITE_MONSTER, STAY, DOWN, TEXT_POKEMONMANSION2F_LANDORUS, LANDORUS, 30
	object_event  3, 17, SPRITE_SUPER_NERD, WALK, LEFT_RIGHT, TEXT_POKEMONMANSION2F_SUPER_NERD, OPP_BURGLAR, 1
