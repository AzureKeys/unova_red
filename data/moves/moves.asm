...
; Characteristics of each move.
	...
	move AIR_SLASH,    FLINCH_SIDE_EFFECT2,         75, FLYING,        95, 20
	...
	move TAIL_SLAP,    TWO_TO_FIVE_ATTACKS_EFFECT,  25, NORMAL,        85, 10
	move NIGHT_SLASH,  NO_ADDITIONAL_EFFECT,        70, DARK,         100, 15
	move AMNESIA,      SPECIAL_UP2_EFFECT,           0, PSYCHIC_TYPE, 100, 20
	move NIGHT_DAZE,   ACCURACY_DOWN_SIDE_EFFECT,   85, DARK,          95, 10
	...
	move HEAD_CHARGE,  RECOIL_EFFECT,              120, NORMAL,       100, 15
	move ACID_ARMOR,   DEFENSE_UP2_EFFECT,           0, POISON,       100, 40
	move STORM_THROW,  NO_ADDITIONAL_EFFECT,        40, FIGHTING,     100, 10
