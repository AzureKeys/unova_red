	...
	const_export SAFARIZONEEAST_TM_SLUDGE_BOMB
...
SafariZoneEast_Object:
	...
	object_event  3,  7, SPRITE_POKE_BALL, STAY, NONE, TEXT_SAFARIZONEEAST_MAX_RESTORE, SHELL_STONE
	object_event 20, 13, SPRITE_POKE_BALL, STAY, NONE, TEXT_SAFARIZONEEAST_CARBOS, CARBOS
	object_event 15, 12, SPRITE_POKE_BALL, STAY, NONE, TEXT_SAFARIZONEEAST_TM_SLUDGE_BOMB, TM_SLUDGE_BOMB
